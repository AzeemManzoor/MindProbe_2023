...
// const secondTenQuestions = questions.slice(81, 100);
...
// //     await axios.post('/api/run-machine-learning');
// //     console.log('Machine learning code running...');
// //     // window.location.href = '/Assessment/Result';

// //   } catch (error) {
// //     console.error('Error executing machine learning code:', error);
// //   }
// // };
...
// const firstTenQuestions = questions.slice(61, 80);
